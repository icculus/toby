...
import last.toby.exceptions.*;
     ...
     */
public abstract class UnaryExpressionLogicContext extends ExpressionLogicContext
{
    public UnaryExpressionLogicContext(int sourceLine)
    {
        super(sourceLine);
    } // Constructor
    ...
    {
        Intrinsic operand = ((LogicContext) children[0]).execute();
        return(executeImpl(operand));
    } // execute

    protected abstract Intrinsic executeImpl(Intrinsic operand1)
                                                 throws FlowException;
} // UnaryExpressionLogicContext

// end of UnaryExpressionLogicContext.java ...
