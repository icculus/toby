...
import last.toby.exceptions.*;
     ...
     */
public class SetFence extends StdFuncLogicContext
{
    protected final String getFuncNameImpl()
    {
        return("__$STDFUNC$__setFence");
    } // getFuncName
    ...
    {
        boolean yn = globalContext.localFromTopOfStack(0).getBooleanValue();

//        _D("stdFuncExecuteImpl", "setting fence value to {" + yn + "}...");
