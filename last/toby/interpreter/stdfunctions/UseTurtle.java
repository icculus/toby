...
import last.toby.exceptions.*;
     ...
     */
public class UseTurtle extends StdFuncLogicContext
{
    protected final String getFuncNameImpl()
    {
        return("__$STDFUNC$__useTurtle");
    } // getFuncName
...
//        _D("stdFuncExecuteImpl", "using turtle #(" + tIdx + ")...");

        tspace.useTurtle(tIdx);
        return(NothingIntrinsic.nothing);
    } // executeImpl
} // UseTurtle

// end of UseTurtle.java ...
