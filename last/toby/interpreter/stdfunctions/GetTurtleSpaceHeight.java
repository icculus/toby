...
import last.toby.exceptions.*;
     ...
     */
public class GetTurtleSpaceHeight extends StdFuncLogicContext
{
    protected final String getFuncNameImpl()
    {
        return("__$STDFUNC$__getTurtleSpaceHeight");
    } // getFuncName
    ...
    {
        double rc = tspace.getTurtleSpaceHeight();
//        _D("stdFuncExecuteImpl", "got turtlespace height: (" + rc + ").");
        return(new NumberIntrinsic(rc));
    } // executeImpl
} // GetTurtleSpaceHeight

// end of GetTurtleSpaceHeight.java ...
