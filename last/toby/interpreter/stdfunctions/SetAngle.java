...
import last.toby.exceptions.*;
     ...
     */
public class SetAngle extends StdFuncLogicContext
{
    protected final String getFuncNameImpl()
    {
        return("__$STDFUNC$__setAngle");
    } // getFuncName
...
//        _D("stdFuncExecuteImpl", "setting turtle angle: (" + angle + ")...");

        tspace.setTurtleAngle(angle);
        return(NothingIntrinsic.nothing);
    } // executeImpl
} // SetAngle

// end of SetAngle.java ...
