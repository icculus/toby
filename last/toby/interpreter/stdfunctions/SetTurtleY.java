...
import last.toby.exceptions.*;
     ...
     */
public class SetTurtleY extends StdFuncLogicContext
{
    protected final String getFuncNameImpl()
    {
        return("__$STDFUNC$__setTurtleY");
    } // getFuncName
    ...
    {
        double y = globalContext.localFromTopOfStack(0).getDoubleValue();

//        _D("stdFuncExecuteImpl", "moving turtle to Y pos: (" + y + ")...");
