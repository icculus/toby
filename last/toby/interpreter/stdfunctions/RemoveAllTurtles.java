...
import last.toby.exceptions.*;
     ...
     */
public class RemoveAllTurtles extends StdFuncLogicContext
{
    protected final String getFuncNameImpl()
    {
        return("__$STDFUNC$__removeAllTurtles");
    } // getFuncName
    ...
    {
//        _D("stdFuncExecuteImpl", "removing all turtles...");
        tspace.removeAllTurtles();
        return(NothingIntrinsic.nothing);
    } // executeImpl
} // RemoveAllTurtles

// end of RemoveAllTurtles.java ...
