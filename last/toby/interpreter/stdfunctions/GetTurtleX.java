...
import last.toby.exceptions.*;
     ...
     */
public class GetTurtleX extends StdFuncLogicContext
{
    protected final String getFuncNameImpl()
    {
        return("__$STDFUNC$__getTurtleX");
    } // getFuncName
    ...
    {
        double rc = tspace.getTurtleX();
//        _D("stdFuncExecuteImpl", "got turtle X pos: (" + rc + ").");
        return(new NumberIntrinsic(rc));
    } // executeImpl
} // GetTurtleX

// end of GetTurtleX.java ...
