...
import last.toby.exceptions.*;
     ...
     */
public class HomeAllTurtles extends StdFuncLogicContext
{
    protected final String getFuncNameImpl()
    {
        return("__$STDFUNC$__homeAllTurtles");
    } // getFuncName
    ...
    {
//        _D("stdFuncExecuteImpl", "homing all turtles...");
        tspace.homeAllTurtles();
        return(NothingIntrinsic.nothing);
    } // executeImpl
} // HomeAllTurtles

// end of HomeAllTurtles.java ...
