...
import last.toby.exceptions.*;
     ...
     */
public class TurnRight extends StdFuncLogicContext
{
    protected final String getFuncNameImpl()
    {
        return("__$STDFUNC$__turnRight");
    } // getFuncName
    ...
    {
        double angle = globalContext.localFromTopOfStack(0).getDoubleValue();

//        _D("stdFuncExecuteImpl", "turning right (" + angle + ") degrees...");

        tspace.rotateTurtle(angle);
        return(NothingIntrinsic.nothing);
    } // executeImpl
} // TurnRight

// end of TurnRight.java ...
