...
import last.toby.exceptions.*;
     ...
     */
public class GetTurtleY extends StdFuncLogicContext
{
    protected final String getFuncNameImpl()
    {
        return("__$STDFUNC$__getTurtleY");
    } // getFuncName
    ...
    {
        double rc = tspace.getTurtleY();
//        _D("stdFuncExecuteImpl", "got turtle Y pos: (" + rc + ").");
        return(new NumberIntrinsic(rc));
    } // executeImpl
} // GetTurtleY

// end of GetTurtleY.java ...
