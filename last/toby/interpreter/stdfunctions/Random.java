...
import last.toby.exceptions.*;
     ...
     */
public class Random extends StdFuncLogicContext
{
    protected final String getFuncNameImpl()
    {
        return("__$STDFUNC$__random");
    } // getFuncName
    ...
    {
        double retNum = Math.random();
        NumberIntrinsic retVal = new NumberIntrinsic(retNum);

//        _D("stdFuncExecuteImpl", "random() giving us (" + retNum + ")...");
