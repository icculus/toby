...
import last.toby.exceptions.*;
     ...
     */
public class HideAllTurtles extends StdFuncLogicContext
{
    protected final String getFuncNameImpl()
    {
        return("__$STDFUNC$__hideAllTurtles");
    } // getFuncName
    ...
    {
//        _D("stdFuncExecuteImpl", "hiding all turtles...");
        tspace.hideAllTurtles();
        return(NothingIntrinsic.nothing);
    } // executeImpl
} // HideAllTurtles

// end of HideAllTurtles.java ...
