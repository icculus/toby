...
import last.toby.exceptions.*;
     ...
     */
public class CleanupTurtleSpace extends StdFuncLogicContext
{
    protected final String getFuncNameImpl()
    {
        return("__$STDFUNC$__cleanupTurtleSpace");
    } // getFuncName
    ...
    {
//        _D("stdFuncExecuteImpl", "cleaning up...");
        tspace.cleanup();
        return(NothingIntrinsic.nothing);
    } // executeImpl
} // CleanupTurtleSpace

// end of CleanupTurtleSpace.java ...
