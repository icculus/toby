...
import last.toby.exceptions.*;
     ...
     */
public class GoBackward extends StdFuncLogicContext
{
    protected final String getFuncNameImpl()
    {
        return("__$STDFUNC$__goBackward");
    } // getFuncName
    ...
    {
        double dist = -(globalContext.localFromTopOfStack(0).getDoubleValue());

//        _D("stdFuncExecuteImpl", "advancing turtle by (" + dist + ")...");

        tspace.advanceTurtle(dist);
        return(NothingIntrinsic.nothing);
    } // executeImpl
} // GoBackward

// end of GoBackward.java ...
