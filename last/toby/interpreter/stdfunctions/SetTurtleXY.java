...
import last.toby.exceptions.*;
     ...
     */
public class SetTurtleXY extends StdFuncLogicContext
{
    protected final String getFuncNameImpl()
    {
        return("__$STDFUNC$__setTurtleXY");
    } // getFuncName
    ...
    {
        double x = globalContext.localFromTopOfStack(0).getDoubleValue();
        double y = globalContext.localFromTopOfStack(1).getDoubleValue();

//        _D("stdFuncExecuteImpl", "moving turtle to (" +x+ ", " +y+ ")...");
