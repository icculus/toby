...
import last.toby.exceptions.*;
     ...
     */
public class Pause extends StdFuncLogicContext
{
    protected final String getFuncNameImpl()
    {
        return("__$STDFUNC$__pause");
    } // getFuncName
    ...
    {
        int ms = globalContext.localFromTopOfStack(0).getIntValue();

//        _D("stdFuncExecuteImpl", "pausing for " + ms + " milliseconds.");
