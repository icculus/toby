...
import last.toby.exceptions.*;
     ...
     */
public class GetTurtleCount extends StdFuncLogicContext
{
    protected final String getFuncNameImpl()
    {
        return("__$STDFUNC$__getTurtleCount");
    } // getFuncName
    ...
    {
        int rc = tspace.getTurtleCount();
//        _D("stdFuncExecuteImpl", "got turtle count: (" + rc + ").");
        return(new NumberIntrinsic(rc));
    } // executeImpl
} // GetTurtleCount

// end of GetTurtleCount.java ...
