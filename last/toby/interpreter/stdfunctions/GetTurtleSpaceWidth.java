...
import last.toby.exceptions.*;
     ...
     */
public class GetTurtleSpaceWidth extends StdFuncLogicContext
{
    protected final String getFuncNameImpl()
    {
        return("__$STDFUNC$__getTurtleSpaceWidth");
    } // getFuncName
    ...
    {
        double rc = tspace.getTurtleSpaceWidth();
//        _D("stdFuncExecuteImpl", "got turtlespace width: (" + rc + ").");
        return(new NumberIntrinsic(rc));
    } // executeImpl
} // GetTurtleSpaceWidth

// end of GetTurtleSpaceWidth.java ...
