...
{
    protected ExpressionLogicContext returnExpr = null;

    public ReturnLogicContext(int sourceLine, ExpressionLogicContext expr)
    {
        super(sourceLine);
    ...
    {
        this.returnExpr.link(glob);
    } // linkImpl
} // ReturnLogicContext

// end of ReturnLogicContext.java ...
