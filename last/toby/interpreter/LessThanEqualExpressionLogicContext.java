...
import last.toby.exceptions.FlowException;
     ...
     */
public class LessThanEqualExpressionLogicContext
                extends BinaryExpressionLogicContext
{
    public LessThanEqualExpressionLogicContext(int sourceLine)
    {
        super(sourceLine);
    } // Constructor
...
} // LessThanEqualExpressionLogicContext

// end of LessThanEqualExpressionLogicContext.java ...
