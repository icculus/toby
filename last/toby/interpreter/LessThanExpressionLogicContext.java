...
import last.toby.exceptions.FlowException;
     ...
     */
public class LessThanExpressionLogicContext
                extends BinaryExpressionLogicContext
{
    public LessThanExpressionLogicContext(int sourceLine)
    {
        super(sourceLine);
    } // Constructor
...
} // LessThanExpressionLogicContext

// end of LessThanExpressionLogicContext.java ...
