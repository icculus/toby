...
import last.toby.exceptions.FlowException;
     ...
     */
public class ModuloExpressionLogicContext
                extends BinaryExpressionLogicContext
{
    public ModuloExpressionLogicContext(int sourceLine)
    {
        super(sourceLine);
    } // Constructor
...
//        _D("executeImpl", "modulo [" + o0 + "] % [" + o1 + "]...");

        Intrinsic retVal = new NumberIntrinsic();
        retVal.setValue(o0 % o1);
        return(retVal);
    } // executeImpl
} // ModuloExpressionLogicContext

// end of ModuloExpressionLogicContext.java ...
