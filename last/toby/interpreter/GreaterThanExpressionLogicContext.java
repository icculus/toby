...
import last.toby.exceptions.FlowException;
     ...
     */
public class GreaterThanExpressionLogicContext
                extends BinaryExpressionLogicContext
{
    public GreaterThanExpressionLogicContext(int sourceLine)
    {
        super(sourceLine);
    } // Constructor
...
} // GreaterThanExpressionLogicContext

// end of GreaterThanExpressionLogicContext.java ...
