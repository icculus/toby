...
{
    public AdditionExpressionLogicContext(int sourceLine)
    {
        super(sourceLine);
    } // Constructor
...
//        _D("executeImpl", "adding [" + o1 + "] to [" + o0 + "]...");

        Intrinsic retVal = new NumberIntrinsic();
        retVal.setValue(o0 + o1);
        return(retVal);
    } // executeImpl
} // AdditionExpressionLogicContext

// end of AdditionExpressionLogicContext.java ...
