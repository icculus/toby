...
import last.toby.exceptions.FlowException;
     ...
     */
public class GreaterThanEqualExpressionLogicContext
                extends BinaryExpressionLogicContext
{
    public GreaterThanEqualExpressionLogicContext(int sourceLine)
    {
        super(sourceLine);
    } // Constructor
...
//                            operand1.toString() + "])....");
        ...
        boolean rc = (operand0.compare(operand1) >= 0);

//        _D("executeImpl", "comparison result: {" + rc + "}.");

        return(new BooleanIntrinsic(rc));
    } // executeImpl
} // GreaterThanEqualExpressionLogicContext

// end of GreaterThanEqualExpressionLogicContext.java ...
