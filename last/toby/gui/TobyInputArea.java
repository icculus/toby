                                                     ...
                                                     SourceWatcher
{
    ...
    private void highlightLine(int lineNum)
    {
        ...
        inputArea.select(0, 0);  // clear any old selection.
    ...
    private void buildComponents(TobyFrame frame)
    /**
...
//            highlightLine(lineNum);
    ...
    public void sourceError(ExecException e)
    {
        highlightLine(e.exceptionLine);
    } // sourceError
