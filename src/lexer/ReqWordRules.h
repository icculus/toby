...
#ifndef _INCLUDE_REQWORDRULES_H_
#define _INCLUDE_REQWORDRULES_H_
...
{
public:
    ReqWordRules(const char *_word);
    virtual ~ReqWordRules(void);
...
#endif // !defined _INCLUDE_REQWORDRULES_H_

// end of ReqWordRules.h ...
