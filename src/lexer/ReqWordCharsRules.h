...
#ifndef _INCLUDE_REQWORDCHARRULES_H_
#define _INCLUDE_REQWORDCHARRULES_H_
...
protected:
    size_t numChildren;
    LexerRules **children;
}; // class ReqWordCharsRules

#endif // !defined _INCLUDE_REQWORDCHARRULES_H_

// end of ReqWordCharsRules.h ...
