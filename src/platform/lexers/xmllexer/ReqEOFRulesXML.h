...
#ifndef _INCLUDE_REQEOFRULESXML_H_
#define _INCLUDE_REQEOFRULESXML_H_
...
/*
 * A subclass of ReqEOFRules that constructs itself based on an XML node,
 *  and can output a string containing the C++ code needed to construct
 *  its parent.
 *
 *     Written by Ryan C. Gordon. (icculus@icculus.org)
 */
class ReqEOFRulesXML : public ReqEOFRules
{
public:
    virtual ~ReqEOFRulesXML(void);
...
private:
    ...
    ReqEOFRulesXML(void);
}; // class ReqEOFRulesXML

#endif // !defined _INCLUDE_REQEOFRULESXML_H_

// end of ReqEOFRulesXML.h ...
