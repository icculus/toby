...
#include "platform/loaders/nullloader/NullLoader.h"


NullLoader::NullLoader(const char *binaryName)
    : TobyLoader(binaryName)
{
} // Constructor


NullLoader::~NullLoader(void)
{
} // Destructor


void *NullLoader::getSymbol(const char *sym)
{
    return(NULL);
